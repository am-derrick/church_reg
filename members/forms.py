...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            (attrs={'placeholder': 'This is where you currently live i.e. City, Town, Estate etc.',
                                                'class': 'form-control'}),
            'is_student': forms.RadioSelect
            (attrs={'class': 'form-check-input'}),
            ...
            (attrs={'placeholder': 'Location of Institution', 'class': 'form-control'}),
